...
<div class="first-left-hand-side newlistrow">
    ...
    <div class="middle-section-categories">
        <div class="product-category-left-side cotnentare01">
            <div class="overled-content-box">
                <h3><?php echo ucwords(strtolower($heading)); ?></h3>
                <div class="parentCatcontent"><?php echo $values; ?></div>
            </div>
        </div>
        <div class="product-category-right-side imgarea01">
