...
<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'woocommerce-table__line-item order_item', $item, $order ) ); ?>">
	...
	<td class="woocommerce-table__product-quantity product-quantity" style="text-align: center;" data-title="Quantity">
		<?php 
	...
	<td class="woocommerce-table__product-total product-total" data-title="Subtotal">
